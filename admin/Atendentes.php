    ...
    <main class="cabeça">
        <div class="tablesInd">
            <div class="titulo-paciente">
                <h3 class="index">Atendentes cadastrados</h3>
            </div>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td class='informacaion-tabela'>
                                <a class='link-icon' href='editar_Atendente.php?id=" . htmlspecialchars($row['cd_funcionario']) . "' aria-label='Edit'><i class='bi bi-pencil'></i></a>  
                        ...
                        echo "<tr><td colspan='4'>Nenhum atendente cadastrado.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
