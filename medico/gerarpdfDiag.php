...
$diagPri = $_POST['diagPri'];
$tempoDoenca = $_POST['tempoDoenca'];
$diagSecList = json_decode($_POST['diagSecList']);
...
if (!$result) {
    ...
    if ($result1->num_rows > 0) {
        ...
        ';
            ...
            <hr>
            <h1>Diagnóstico</h2>
            <p><strong>Diagnóstico Primário:<br></strong> ' . $diagPri . '</p>
            <p><strong>Tempo de doença:</strong> ' . $tempoDoenca . '</p>
            <h2>Diagnósticos Secundários:</h2>
            ';

            // Adiciona diagnósticos secundários
            foreach ($diagSecList as $diagSec) {
                $html_body .= '<p>' . $diagSec . '</p>';
            }
        ...
        ';
            ...
            $pdfFilePath = '../documentos_originais/diagnostico/' . hash('sha256', $pdfOutput) . '.pdf'; // Caminho onde o PDF será salvo
